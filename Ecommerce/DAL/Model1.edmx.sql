...
-- --------------------------------------------------
-- Date Created: 10/02/2023 21:26:23
-- Generated from EDMX file: C:\Users\Boban\source\repos\EcommerceApp\Ecommerce\DAL\Model1.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__Tbl_Cart__Produc__38996AB5]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Cart] DROP CONSTRAINT [FK__Tbl_Cart__Produc__38996AB5];
GO
IF OBJECT_ID(N'[dbo].[FK__Tbl_Produ__Categ__398D8EEE]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Product] DROP CONSTRAINT [FK__Tbl_Produ__Categ__398D8EEE];
GO
...
ALTER TABLE [dbo].[Tbl_Cart]
ADD CONSTRAINT [FK__Tbl_Cart__Produc__38996AB5]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Cart__Produc__38996AB5'
CREATE INDEX [IX_FK__Tbl_Cart__Produc__38996AB5]
ON [dbo].[Tbl_Cart]
    ([ProductId]);
GO
...
ALTER TABLE [dbo].[Tbl_Product]
ADD CONSTRAINT [FK__Tbl_Produ__Categ__398D8EEE]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Produ__Categ__398D8EEE'
CREATE INDEX [IX_FK__Tbl_Produ__Categ__398D8EEE]
ON [dbo].[Tbl_Product]
    ([CategoryId]);
GO
